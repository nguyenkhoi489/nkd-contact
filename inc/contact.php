            ...
            <form method="post" action="options.php">
                ...
                <table class="form-table">
                    ...
                    <tr valign="top">
                        ...
                        <td>
                            <input placeholder="0123 456 789" type="text" name="config_hotline_2" value="<?php echo get_option('config_hotline_2'); ?>" />
                            <input placeholder="Tooltip Tile" type="text" name="config_hotline_2_tooltip" value="<?php echo get_option('config_hotline_2_tooltip'); ?>" />
                        </td>
                    ...
                    <tr valign="top">
                        ...
                        <td>
                            <input placeholder="0123 456 789" type="text" name="config_hotline_3" value="<?php echo get_option('config_hotline_3'); ?>" />
                            <input placeholder="Tooltip Tile" type="text" name="config_hotline_3_tooltip" value="<?php echo get_option('config_hotline_3_tooltip'); ?>" />
                        </td>
                    ...
                    <tr valign="top">
                        ...
                        <td><input placeholder="Link telegram" type="text" name="config_telegram" value="<?php echo get_option('config_telegram'); ?>" />
                            <input placeholder="Tooltip Tile" type="text" name="config_telegram_tooltip" value="<?php echo get_option('config_telegram_tooltip'); ?>" />
                        </td>
                    </tr>
                    <tr valign="top">
